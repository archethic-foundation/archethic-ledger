...
UX_STEP_NOCB(ux_menu_ready_step, pnn, {&C_archethic, "Archethic", "is Ready"});
UX_STEP_NOCB(ux_menu_version_step, bn, {"Version", APPVERSION});
UX_STEP_CB(ux_menu_about_step, pb, ui_menu_about(), {&C_archethic, "About"});
...
UX_STEP_NOCB(ux_menu_info_step, bn, {"Archethic App", "(c) 2022 Uniris"});
